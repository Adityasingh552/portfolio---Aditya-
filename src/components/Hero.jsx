    ...
    return (
        <section id="hero" className="relative pt-12 pb-8 sm:pt-20 sm:pb-16 flex flex-col items-center justify-center text-center">
            ...
            {personal.profileImage && (
                ...
                >
                    <div className="absolute -inset-1 rounded-full bg-gradient-to-r from-[#d4af37] via-[#f3e5ab] to-[#800020] opacity-75 blur-md group-hover:opacity-100 transition duration-500 animate-pulse-slow" />
                    <div className="relative w-28 h-28 sm:w-32 sm:h-32 rounded-full border-2 border-[#d4af37]/60 overflow-hidden bg-[#150709] shadow-2xl flex items-center justify-center">
                        {!imgError ? (
                            <img
